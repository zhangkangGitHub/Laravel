...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/s/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="/s/assets/css/ace-skins.min.css" />
		...
		<!--[if lte IE 8]>
		  <script src="/s/assets/js/excanvas.min.js"></script>
		<![endif]-->
		<script src="/s/assets/js/ace-elements.min.js"></script>
		<script src="/s/assets/js/ace.min.js"></script>
        ...
        <script src="/s/js/jquery.nicescroll.js" type="text/javascript"></script>
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="https://item.taobao.com/item.htm?id=539837098284" class="navbar-brand">
						<small>					
						<img src="/s/images/logo.png" width="470px">
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
               ...
               <ul class="nav ace-nav">	
				...
				<a data-toggle="dropdown" href="#" class="dropdown-toggle">
				 <span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>{{$users->nickname}}</span>
				...
				<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
				 ...
				 <li class="divider"></li>
				 <li><a href="/shop/outlogin" id="Exit_system"><i class="icon-off"></i>退出</a></li>
				</ul>
			   </li>
	           <li class="purple">
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
				     <li class="home"><a href="javascript:void(0)" name="shop/inpic" onClick="getMthod(this);" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" name="shop/plist" onClick="getMthod(this);"  title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
						 <li class="home"><a  href="javascript:void(0)" name="shop/brand" title="品牌管理"  class="iframeurl"><i class="icon-double-angle-right"></i>品牌管理</a></li>
                    ...
                    <ul class="submenu">
					<li class="home"><a href="javascript:void(0)" name="shop/order" title="交易订单（图）"  class="iframeurl"><i class="icon-double-angle-right"></i>交易订单(图)</a></li>
                    <li class="home"><a href="javascript:void(0)" name="shop/orderform" title="订单管理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单管理</a></li>
                    <li class="home"><a href="javascript:void(0)" name="shop/amount" title="交易金额"  class="iframeurl"><i class="icon-double-angle-right"></i>交易金额</a></li>
                    <!-- <li class="home"><a href="javascript:void(0)" name="Order_handling.html" title="订单处理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单处理</a></li> -->
					  <li class="home"><a href="javascript:void(0)" name="shop/refund" title="退款管理"  class="iframeurl"><i class="icon-double-angle-right"></i>退款管理</a></li>
                   </ul>
				  </li>
                   <!-- <li>
				  ...
				  <li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 店铺管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" name="shop/slist" title="店铺列表" class="iframeurl"><i class="icon-double-angle-right"></i>店铺列表</a></li>
                                <li class="home"><a href="javascript:void(0)" name="shop/audit" title="店铺审核" class="iframeurl"><i class="icon-double-angle-right"></i>店铺审核<span class="badge badge-danger">5</span></a></li>
							</ul>
						</li>
						<li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i><span class="menu-text"> 消息管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" name="shop/comment" title="留言列表" class="iframeurl"><i class="icon-double-angle-right"></i>留言列表</a></li>
                                <li class="home"><a href="javascript:void(0)" name="shop/feedback" title="意见反馈" class="iframeurl"><i class="icon-double-angle-right"></i>意见反馈</a></li>
							</ul>
						</li>
						<li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 文章管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" name="shop/alist" title="文章列表" class="iframeurl"><i class="icon-double-angle-right"></i>文章列表</a></li>
                                <li class="home"><a href="javascript:void(0)" name="shop/asort" title="分类管理" class="iframeurl"><i class="icon-double-angle-right"></i>分类管理</a></li>
							</ul>
						</li>
           ...
           $("#menu_style").niceScroll({  
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
                 ...
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="shop/inpic">  </iframe>
...
<script>
	function getMthod(ment){
		console.log(ment.name);
		$('#iframe').attr('src',ment.name);
		console.log($('#iframe'));
		return false;
	}
</script>
