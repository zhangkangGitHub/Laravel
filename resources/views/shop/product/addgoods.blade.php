...
<!--[if lt IE 9]>
<script type="text/javascript" src="/s/js/html5.js"></script>
<script type="text/javascript" src="/s/js/respond.min.js"></script>
<script type="text/javascript" src="/s/js/PIE_IE678.js"></script>
<![endif]-->
...
<link href="/s/Widget/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
...
@endif
   ...
   <div class="type_title">添加商品</div>
	<form action="/shop/prodcut/doaddGoods" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		{{csrf_field()}}
		...
		<div class=" clearfix cl">
			...
			<div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="company"></div>
			</div>
            <div class="Add_p_s">
            ...
            <div class="Add_p_s">
			 ...
			 <!-- <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="bid"></div> -->
			 	<div class="formControls col-2"><span class="select-box">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="unit" ></div>
			</div>
            <div class="Add_p_s">
			...
			<div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="specification1"></div>
			</div>
			<div class="Add_p_s">	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="specification2"></div>
			</div>
			<div class="Add_p_s">	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="specification3"></div>
			</div>
			</div>
			<div style="float:left;">
			<div class="Add_p_s">
             <label class="form-label col-2">型&nbsp;&nbsp;&nbsp;&nbsp;号：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="color1"></div>
			</div>
			<div class="Add_p_s">	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="color2"></div>
			</div>
			<div class="Add_p_s">	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="color3"></div>
			</div>
			</div>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<textarea name="descr" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<input type="file" class="input-text" name="picname[]" multiple accept="image/gif, image/jpeg">
			</div>
		</div>
        ...
        <div class="mws-form-row" style="text-align: center;">
            <input type="submit" value="添&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;加" class="btn btn-success mws-login-button">
        </div>
	</form>
    </div>
</div>
...
<script type="text/javascript" src="/s/Widget/My97DatePicker/WdatePicker.js"></script> 
<script type="text/javascript" src="/s/Widget/icheck/jquery.icheck.min.js"></script> 
<script type="text/javascript" src="/s/Widget/zTree/js/jquery.ztree.all-3.5.min.js"></script> 
<script type="text/javascript" src="/s/Widget/Validform/5.3.2/Validform.min.js"></script> 
<script type="text/javascript" src="/s/Widget/webuploader/0.1.5/webuploader.min.js"></script>
<script type="text/javascript" src="/s/Widget/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/s/Widget/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/s/Widget/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script> 
