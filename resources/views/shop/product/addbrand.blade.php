...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="/s/assets/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <script type="text/javascript" src="/s/Widget/swfupload/swfupload.js"></script>
        <script type="text/javascript" src="/s/Widget/swfupload/swfupload.queue.js"></script>
        <script type="text/javascript" src="/s/Widget/swfupload/swfupload.speed.js"></script>
        <script type="text/javascript" src="/s/Widget/swfupload/handlers.js"></script>
</head>
...
<div class=" clearfix">
 ...
 <div class="left_add" style="width:1350px;">
   <div class="title_name" style="width:1350px;">添加品牌</div>
   <ul class="add_conent">
   <form action="/shop/doaddbrand" method="post" enctype="multipart/form-data">
   {{csrf_field()}}
    <li class=" clearfix"><label class="label_name"><i>*</i>品牌名称：</label> <input name="bname" type="text" class="add_text"/></li>
    <li><label class="label_name"><i>*</i>品牌类型：</label>&nbsp;
		<select name="cid">
			<option>请选择</option>
			@foreach($cate as $k=>$v)
    ...
    <li class=" clearfix"><label class="label_name">品牌图片：</label>
    	<input name="blogo" type="file" class="add_text"/>
           <div class="demo l_f" style="display:none">
         ...
         <li class=" clearfix"><label class="label_name"><i>*</i>所属地区：</label> <input name="country" type="text" class="add_text" style="width:120px"/></li>
 ...
 <div class="right_add">
  ...
  <div class="button_brand"><input type="submit"  class="btn btn-warning" value="保存"/><input name="" type="reset" value="取消" class="btn btn-warning"/></div>
  </form>
</div>
</body>
</html>
